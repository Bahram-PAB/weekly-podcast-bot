...
async def async_main():
    ...
    try:
        ...
        caption = (
            ...
            f" پربازدیدترین مطالب کانال‌های کوهنوردی ({date_range})\n"
            f"کانال های کوهنوردی فارسی هر هفته بررسی میشوند و در نهایت از پربازدید ترین کانال های فارسی سناریو پادکست هفتگی تولید میشود.لطفا پادکست های ما را در کانال های خود بازنشر کنید.\n"
